...
<form id="frm" action="/board/paging" method="get">
    <input type="hidden" id="offsetCheck" name="offset" value="0">
...
<script>
    ...
    let offset = document.getElementById("pagination-list").value;
    var paginationList = document.getElementById("pagination-list");
    const pageSizeCheck = document.getElementById("pageSizeCheck").value;
    let offsetCheck = document.getElementById("offsetCheck").value;
    ...
    for (var i = startPage; i <= endPage; i++) {
        ...
        link.addEventListener("click", function (event) {
            ...
            offset = (parseInt(page)*parseInt(pageSizeCheck));
            offsetCheck = offset;
            // 페이지 이동 로직을 추가하세요.
            searchForm.submit();
